#ifndef LKTECH_MG_MOTOR_CANFD_H
#define LKTECH_MG_MOTOR_CANFD_H
...
enum LKTECH_MG_MOTOR_STATUS
{
  LKTECH_MG_MOTOR_STATUS_UNKNOWN,
  LKTECH_MG_MOTOR_STATUS_ENABLED,
  LKTECH_MG_MOTOR_STATUS_DISABLED
};
...
typedef struct
{
  ...
  enum LKTECH_MG_MOTOR_STATUS  status;
  uint32_t                     lastCANReceivedTimestamp;
	float												 gearRatio;
  //CAN BUS transmit
  uint8_t                      txBuf[8];
  uint32_t*                    pTxMailbox;
